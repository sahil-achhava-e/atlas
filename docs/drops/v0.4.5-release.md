...
<div class="stage">
  ...
  <section class="page p1">
    <div class="content">
      <p class="eyebrow">Atlas &middot; v0.4.5</p>
      ...
      shaped what Atlas is today. <b>This release is built on that.</b> So before the
      ...
      <div class="two">
        ...
        <div class="band">
          ...
          <span>A month of Atlas Pro free, then 50% off the annual plan. For the first
