...
docs/                        `logo.png`, `banner.png`, landing page (GitHub Pages → github.com/sahilethara/atlas)
...
[`DESIGN.md`](../DESIGN.md) is canonical; every component derives from its tokens. The Atlas
