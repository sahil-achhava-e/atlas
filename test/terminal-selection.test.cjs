...
test('the reported paste: Claude Code blockquote rail is dropped', () => {
  assert.equal(
    sanitizeTerminalSelection('▎ Atlas — clones for you and your team, working 24/7.'),
    'Atlas — clones for you and your team, working 24/7.'
  );
});

test('every line of a multi-line quote loses its rail', () => {
  const copied = [
    '▎ Atlas is live on Product Hunt today.',
    '▎',
