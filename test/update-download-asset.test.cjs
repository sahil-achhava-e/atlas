...
const assets = [
  { name: 'Atlas-0.5.0-mac-arm64.dmg', browser_download_url: 'https://github.com/x/y/releases/download/v0.5.0/Atlas-0.5.0-mac-arm64.dmg' },
  { name: 'Atlas-0.5.0-mac-arm64.zip', browser_download_url: 'https://github.com/x/y/releases/download/v0.5.0/Atlas-0.5.0-mac-arm64.zip' },
  { name: 'Atlas-0.5.0-mac-x64.dmg', browser_download_url: 'https://github.com/x/y/releases/download/v0.5.0/Atlas-0.5.0-mac-x64.dmg' },
  { name: 'Atlas-0.5.0-win-x64-setup.exe', browser_download_url: 'https://github.com/x/y/releases/download/v0.5.0/Atlas-0.5.0-win-x64-setup.exe' },
  { name: 'Atlas-0.5.0-win-x64-portable.exe', browser_download_url: 'https://github.com/x/y/releases/download/v0.5.0/Atlas-0.5.0-win-x64-portable.exe' },
  { name: 'Atlas-0.5.0-linux-x86_64.AppImage', browser_download_url: 'https://github.com/x/y/releases/download/v0.5.0/Atlas-0.5.0-linux-x86_64.AppImage' },
